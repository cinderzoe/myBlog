...
.headPic .head-credit{position: absolute;width: 100%;height: 100%;top: 0;left: 0;background-color: rgba(0,0,0,0.4);color: #fff;text-align: center;padding-top: .4rem;box-sizing:border-box;z-index: 1;}
